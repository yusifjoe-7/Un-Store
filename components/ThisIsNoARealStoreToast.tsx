...
function NoARealStoreToast() {
  ...
  return (
    ...
    z-300
    '>
        <div className="py-10 w-[95%] md:w-fit px-10  bg-card shadow-lg rounded-xl z-310
        ...
        ">
            ...
            <p>try any words with @ in the middle and it will works</p>
        <Button className="px-20 py-5 border-2 border-primary hover:bg-card hover:text-card-foreground rounded-full bg-primary mt-10 cursor-pointer"
